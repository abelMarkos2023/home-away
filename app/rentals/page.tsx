...
async function RentalsPage() {
  ...
  if ((Array.isArray(rentals) && rentals?.length === 0) || !rentals || 'message' in rentals) {
    return (
      <EmptyList
      ...
      <Table>
        ...
        <TableBody>
          {rentals.map((rental) => {
            ...
            const { totalNights, totalRevenue: orderTotalSum } = rental;
            return (
              <TableRow key={propertyId}>
                ...
                <TableCell>{totalNights || 0}</TableCell>
